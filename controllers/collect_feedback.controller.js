...
exports.postRecords = async (req, res, next) => {
    ...
    try {
        ...
        if (!collect_feedback) {
            ...
            <p>Please click <a href="https://phpstack-988002-3467030.cloudwaysapps.com/tkn/${tkn}">here</a> to share your feedback. Results will be kept anonymous and shared in aggregate. The survey link will be active until ${EndDate}</p>
